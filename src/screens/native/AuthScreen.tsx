...
export const AuthScreen: React.FC<AuthScreenProps> = ({
  ...
  const handleDemoLogin = (role: UserRole) => {
    if (role === 'customer') {
      ...
      onAuthSuccess(demoClient, 'customer');
    } else {
      const demoStudio: UserProfile = {
        id: 'usr-wren',
        name: 'Rowan Wren',
      ...
      onAuthSuccess(demoStudio, 'provider');
    }
  };
    ...
    >
      ...
      <View style={styles.topSealBox}>
        ...
        <Text style={styles.topSubtitle}>
          Single unified passbook for booking artisans & managing your studio
        </Text>
      </View>
      ...
      <View style={styles.formCard}>
        ...
        <View style={styles.cardHeaderStub}>
          <Text style={styles.cardStubNumber}>
            {authMode === 'signin' ? 'LEDGER PASS ENTRY • 001' : 'NEW REGISTRATION • 002'}
          </Text>
        ...
        <View style={styles.formBody}>
          ...
          {/* Business / Studio Upgrade Option in Register */}
          {authMode === 'register' && (
            <TouchableOpacity
              activeOpacity={0.85}
              onPress={() => setIsRegisteringStudio(!isRegisteringStudio)}
              style={[
                styles.studioOptionBox,
                isRegisteringStudio && styles.studioOptionBoxActive,
              ]}
            >
              <View style={styles.studioOptionHeader}>
                ...
                <View style={styles.studioOptionTextCol}>
                  ...
                  <Text style={styles.studioOptionSub}>
                    Enables studio catalog, working hours & appointment ledger
                  </Text>
                </View>
                <View
                  style={[
                    styles.checkboxCircle,
                    isRegisteringStudio && styles.checkboxCircleActive,
                  ]}
                >
...
const styles = StyleSheet.create({
  ...
  studioSubInputBox: {
    ...
    paddingTop: 10,
    borderTopWidth: 1,
    borderTopColor: 'rgba(206, 196, 203, 0.5)',
  },
  studioNameInput: {
    backgroundColor: Colors.alabasterCard,
    borderWidth: 1,
